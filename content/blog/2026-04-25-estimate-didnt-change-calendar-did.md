...
tags: []
linkedin_copy: |
  Timeline compression does not reduce scope. It relocates risk to the people least equipped to name it.
  
  I have watched this pattern play out on commerce replatforms for fifteen years. The merchant asks "can we do this in fewer weeks." The answer that gets agreed to is yes, with no corresponding scope reduction. The gap between the original estimate and the new calendar does not disappear. It gets absorbed silently into the project as risk.
  
  It surfaces about three sprints in. Re-estimation cycles start. Resources get rebalanced across projects that were supposed to be sequential. Integration bottlenecks appear because the merchant's approval boards and security reviews operate on their own cadence, not yours. And estimate ownership becomes ambiguous: did the team commit to the number they built, or the number the deal required?
  
  The structural problem is that nobody in the negotiation room owns the gap. Sales wants to close. The merchant wants the full scope on the shorter timeline. Delivery, if they are even present, does not want to be the person who reopens scope conversations.
  
  The fix is simple and almost never executed: if the timeline compresses, the scope compresses in writing, in the same conversation, before the SOW is signed. Not "we will figure out what to defer in sprint planning." A written list, agreed by the merchant's project sponsor, of what moves to post-launch.
  
  This discipline costs ten minutes at the negotiation table. Skipping it costs three months of trust erosion during delivery.
